...
const validationSchema = Yup.object({ 
    ...
    return (
        <div className="resetpwd-body">
            <div className='shadow-myBoxShadow resetpwd-form-container'>
                    ...
                    >
                        {
                            formik=> {
                                    return <Form>
                                                <FormikControl className={inputClass} control='passwordCombo' label='Email'/>
                ...
                <ModalControler modalVisiblity={modalState.visibility} modalType='alert' title='Password sucessfully re-set!!!' sentData={fetchedData} redirectTo='/handyman/login'/>:null}
            </div>
        </div>
    );
}
