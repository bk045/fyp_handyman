...
import { COLUMNS, GROUPED_COLUMNS } from "./iCustomerColumns";
...
const ICustomerTable = ({REQUEST_DATA}) => {
    ...
    const toEditPage=(obj)=>{
        redirectTo("/handyman/profile/edit_i_customer",
        {state:{obj}});
    };
