...
import { COLUMNS, GROUPED_COLUMNS } from "./iCatererColumns";
...
const ICatererTable = ({REQUEST_DATA}) => {
    ...
    const toEditPage=(obj)=>{
        redirectTo("/handyman/profile/edit_i_caterer",
        {state:{obj}});
    };
