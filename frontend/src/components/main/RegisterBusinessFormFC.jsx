...
const userTypeOptions = [
    {key:'Customer', value:'business'},
    {key:'Service Provider', value:'business caterer'},
]

const RegisterBusinessUserFC = () => {
    const initialValues = {
        email:'',
        password:'',
        cpassword:'',
...
export default RegisterBusinessUserFC;