...
const FormModalPasswordReset = ({closeModal, onYes, title, redirectTo}) => {
                ...
                >
                    {
                        formik=> {
                                return <Form>
                                        <FormikControl className={inputClass} control='input' type='text' name='email' label='Email'/>
...
export default FormModalPasswordReset;