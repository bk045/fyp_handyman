...
import { COLUMNS, GROUPED_COLUMNS } from "./bCatererColumns"
...
const BCatererTable = ({REQUEST_DATA}) => {
    ...
    const toEditPage=(obj)=>{
        redirectTo("/handyman/profile/edit_b_caterer",
        {state:{obj}});
    };
